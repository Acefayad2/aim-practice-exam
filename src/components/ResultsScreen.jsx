      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '32px 20px' }}>
        ...
        {activeTab === 'summary' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {/* Score needed */}
            {!passed && (
              <div style={{ background: '#F0EAF8', border: `2px solid ${BLUE}`, borderRadius: 14, padding: '20px 24px' }}>
    ...
    <div style={{
      ...
      {open && (
        <div style={{ borderTop: '1px solid #f0f4f8', padding: '16px 22px 20px' }}>
          ...
          {/* Explanation */}
          <div style={{ background: '#F0EAF8', border: `1px solid #C9A8E8`, borderRadius: 10, padding: '14px 16px' }}>
